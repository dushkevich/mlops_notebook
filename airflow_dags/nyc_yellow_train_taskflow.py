...
def pipeline():
    ...
    def train():
        ...
        year = 2023 # int(train_dt.strftime("%Y"))
        month = 3 # int(train_dt.strftime("%m"))

        # Your run() will automatically use (year, month+1) as VALIDATION
        return run(year, month, 'yellow')
